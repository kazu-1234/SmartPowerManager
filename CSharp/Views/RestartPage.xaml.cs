...
public sealed partial class RestartPage : Page, ISchedulePage
{
    ...
    private const string Action = AppConstants.ActionRestart;
    ...
    private async void AddWeeklyButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        _weeklyTracker?.Stop();
        await ScheduleActionPageHelper.AddWeeklyAsync(XamlRoot, _state, Action, WeeklyWeekdayBox, WeeklyTimeInput, RefreshAfterChange);
    }
    ...
    private async void AddOnetimeButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        await ScheduleActionPageHelper.AddOnetimeAsync(XamlRoot, _state, Action, OnetimeDateTimeInput, RefreshAfterChange);
    }
